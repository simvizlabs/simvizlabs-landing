    ...
    <div id={id} className="flex flex-col pb-[10px] md:pb-[500px]">
        ...
        titleComponent={
          <>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center w-full gap-4">
              ...
              <PulsatingButton className="h-14 mb-3 rounded-xl" pulseColor="#D4D4D8">Get our Bundle <span className="font-bold text-emerald-400">(20% off)</span></PulsatingButton>
              </Link>
            </div>
          </>
        }
      >
        <Image
          ...
          height={2048}
          width={2732}
          className="mx-auto object-contain  object-left-top"
          draggable={false}
        />
      </ContainerScroll>
    </div>
