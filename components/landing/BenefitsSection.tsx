...
export function BenefitsSection() {
  return (
    <section 
      className="relative w-full mx-auto py-24 overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-8">
        <h2 className="mb-16 max-w-2xl text-4xl font-bold leading-tight tracking-tight text-black sm:text-5xl">
