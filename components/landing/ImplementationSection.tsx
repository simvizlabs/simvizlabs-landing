            ...
            <div className="max-w-[1440px] mx-auto flex flex-col items-center text-center gap-6 md:gap-8 lg:gap-10">
                ...
                <div>
                    ...
                    <div className="relative sm:-top-[5rem] md:-top-[6rem] lg:-top-[16rem]">
                        <Link
                            href="/contact"
                            className="px-6 py-3 sm:px-8 sm:py-4 bg-[#1381e5] hover:bg-[#1381e5]/90 text-white rounded-full font-semibold text-sm sm:text-base leading-normal transition-all shadow-lg whitespace-nowrap font-sans"
                        >
                            Schedule a Demo
                        </Link>
                    </div>
