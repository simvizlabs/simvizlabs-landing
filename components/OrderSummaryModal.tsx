  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent 
        ...
        className={cn(
            "flex flex-col p-6",
            isDesktop ? "w-[85vw] sm:max-w-lg h-[90vh] sm:top-[5vh] sm:right-4 sm:rounded-xl sm:border sm:shadow-2xl" : "w-full max-h-[90vh] rounded-t-xl"
        )}
      >
        <SheetHeader className="mb-6">
          <SheetTitle className="text-3xl font-bold text-gray-900 dark:text-white font-geist">
            Order Summary
          </SheetTitle>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto space-y-6 min-h-0">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <span className="text-xl font-bold text-gray-900 dark:text-white font-geist">
                Order Total
              </span>
              <span className="text-2xl font-bold text-[#1381E5] font-geist">
                {formatAmountDisplay(productAmount)}
              </span>
            </div>
          </div>
          ...
          <div className="pt-4">
            <Button
              ...
              className="w-full rounded-lg bg-[#1381E5] hover:bg-blue-700 px-6 py-6 text-lg font-semibold text-white shadow-lg disabled:opacity-50 font-geist"
            >
              {loading ? (
                <>
