...
export function MarqueeDemo() {
  return (
    <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8 relative flex w-full flex-col items-center justify-center overflow-hidden pt-12 pb-12">
      ...
      Discover how pilots, instructors, and training centers use our simulators, LMS, and data-driven  



<br className="hidden sm:inline" />solutions to streamline learning, improve skills, and enhance operational readiness.
      </p>
