...
export function RetroGridDemo() {
  return (
    <div className="mx-auto max-w-2xl px-8 lg:max-w-7xl lg:px-8 relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-background pt-12">
      <span className="pointer-events-none z-10 whitespace-nowrap bg-gradient-to-r from-blue-500 to-blue-700 bg-clip-text text-center text-6xl font-bold leading-none tracking-tighter text-transparent">
