...
export function HovermeButton({ text, className, ...props }: HovermeButtonProps) {
  return (
    <button className={cn("group relative inline-flex h-[calc(48px+8px)] items-center justify-center rounded-full bg-neutral-900 py-1 pl-6 pr-14 font-medium text-neutral-50 font-geist", className)} {...props}>
