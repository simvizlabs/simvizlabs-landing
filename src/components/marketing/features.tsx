        ...
        <Container>
          <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-700">
              ...
              organization of all the de-identified data and secure record
              keeping for airlines.
            </p>
          </div>
        </Container>
                  ...
                  <div className="bento-card w-full flex-row gap-6">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="text-sm md:text-base mt-2 text-muted-foreground">
                        Leverage the Event-Based Analytics and Training system
                        to understand your workforce, implement targeted
                        programs, and save both time and costs.
                      </p>
                    </div>
                  </div>
                </MagicCard>
                  ...
                  <div className="bento-card w-full flex-row gap-6">
                    ...
                    <div className="flex flex-col mt-auto">
                      ...
                      <p className="text-sm md:text-base mt-2 text-muted-foreground">
                        ...
                        trainee performance, identify gaps, and optimize
                        training programs for better skill development and
                        safety.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="bento-card w-full relative items-center justify-center">
                      <div className="w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <p className="text-base text-muted-foreground text-justify [mask-image:radial-gradient(50%_50%_at_50%_50%,#BAB3FF_0%,rgba(186,179,255,0)_90.69%)]">
                          We use AI to help you create content that resonates
                          with your audience. Our tools are designed to optimize
                          your content creation and engagement like never
                          before. Transform your social media strategy with Luro
                          AI&apos;s cutting-edge features. Reach your audience
                          with the right message at the right time. Create
                          content faster and smarter with Luro AI. Transform
                          your social media strategy with Luro AI&apos;s
                          cutting-edge features. Create content faster and
                          smarter with Luro AI. Transform your social media
                ...
                >
                  <div className="bento-card w-full flex-row gap-6">
                    ...
                    <div className="flex flex-col mt-auto">
                      ...
                      <p className="text-sm md:text-base mt-2 text-muted-foreground">
                        Implement targeted training programs using data
                        analytics to meet specific operational needs, ensuring
