      ...
      <Container delay={0.2}>
        <div className="flex items-center justify-center md:gap-x-6 mt-8 ">
          <Button asChild size="lg">
            <Link href="https://calendly.com/simvizlabs_demo/30min">Schedule a Call</Link>
          </Button>
          <Button
            asChild
            size="lg"
          ...
          >
            <Link href="https://apps.apple.com/us/app/fms-trainer-b747/id6464125512">Download our App</Link>
          </Button>
        </div>
      </Container>
      <Container delay={0.3}>
