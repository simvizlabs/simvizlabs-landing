...
import { IconEdit, IconActivity, IconWifiOff, IconArrowUpRight } from "@tabler/icons-react";
...
const AeronauticalSchoolsPage = () => {
  return (
    <div className="bg-white text-black dark:bg-neutral-900 dark:text-white font-geist">
      <Head>
        <title>Aviation Training for Schools | FMS Labs & ACARS Sim | SimvizLabs</title>
        <meta name="description" content="Enhance aviation education with SimvizLabs' interactive FMS labs, ACARS simulators, lesson builders, and LMS tools for Part-147 & ATC colleges." />
        <meta name="keywords" content="aeronautical school, aviation training, Part-147, ATC training, FMS lab, ACARS simulator, aviation LMS, SimvizLabs" />
      </Head>
      <NavbarDemo />
      <main className="space-y-16 px-6 py-16 max-w-7xl mx-auto">
        ...
        <section className="grid md:grid-cols-2 items-center gap-8">
          <div className="space-y-4">
            <h1 className="mt-6 max-w-[20ch] text-3xl xs:text-4xl sm:text-5xl lg:text-[2.75rem] xl:text-5xl font-extrabold !leading-[1.2] tracking-tight">Bridge the Theory–Practice Gap</h1>
          ...
          <div>
            <Image
              src="/placeholder.svg"
              alt="Instructor using SimvizLabs' real-time panel to monitor student progress in an aeronautical school" // Updated Alt Text
              width={600}
              height={400}
