...
const TypeRatingOrganizationsPage = () => {
  return (
    <div className="bg-white text-black dark:bg-neutral-900 dark:text-white font-geist">
      ...
      <Head>
        <title className="font-geist">Type Rating Training Solutions | EBAT & FMC Emulators | SimViz Labs</title>
        <meta name="description" content="Specialized training solutions for type rating organizations, featuring SimViz Labs' tablet FMC emulators, EBAT dashboards, CPDLC/Non-Normal packs, and data-driven refresher solutions." className="font-geist" />
        <meta name="keywords" content="type rating training, pilot training solutions, EBAT system, FMC emulator, CPDLC training, non-normal procedures, flight operations, SimViz Labs" className="font-geist" />
      </Head>
      <NavbarDemo />
