...
export const metadata = {
    ...
    keywords: [
        ...
        "Simulator preparedness",
        "FFS training optimization",
        "Flight training efficiency",
        "Aviation training technology",
        "Digital flight training",
        "Tablet-based flight training",
        "Mobile flight training",
    ],
    openGraph: {
        title: "Approved Training Organisation Software | ATO FMS Simulator | CBTA Compliant",
        ...
        type: "website",
        url: "https://simvizlabs.com/approved-training-organisations",
    },
    alternates: {
        canonical: "https://simvizlabs.com/approved-training-organisations",
    },
};
