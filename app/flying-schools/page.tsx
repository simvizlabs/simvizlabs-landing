...
const features = [
  {
    number: "1.",
    title: <>Modernize your <br /> Training Programs </>,
    description:
  ...
  {
    number: "2.",
    title: <>Enhanced Employability & <br /> Curriculum Value</>,
    description:
