    ...
    <div className="bg-white py-24 sm:py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center pb-4">
          <Link href="/our-products" className="inline-flex items-center gap-1 rounded-md bg-gray-100 px-3 py-2 mb-4 text-sm font-semibold text-gray-600 hover:bg-gray-200">
